...
describe Sprockets::Less do
  ...
  xit 'adds the #asset_path helper' do
  ...
  describe Sprockets::Less::LessTemplate do
    ...
    describe 'initialize_engine' do
      ...
      it 'does add Sass functions if sprockets-helpers is not available' do
        ...
        Sprockets::Less::LessTemplate.any_instance.should_receive(:require).with('sprockets/helpers').and_raise LoadError
        Sprockets::Less::LessTemplate.any_instance.should_not_receive(:require).with 'sprockets/less/functions'
        template
      ...
      it 'does not add Sass functions if add_less_functions is false' do
        ...
        template.should_not_receive(:require).with 'sprockets/less/functions'
